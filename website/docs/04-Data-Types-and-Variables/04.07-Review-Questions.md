...
Q04.13 What floating point number converts to the boolean ```False?``` Show this in code and the ```bool()``` function.
...
(c) Truncate the decimal portion of $e$ (remove the 0.71828.... portion) so you are left with the integer ```2```. Store the result in a variable called ```z```.
...
Q04.24 Create the floating point number $0.001 \times 10^{-0.2}$ and assign it to the variable ```b```.
...
Q04.36 Convert the string ```Problem``` to the list ```['P','r','o','b','l','e','m']``` without rewriting the list from scratch.

Q04.37 Use the string ```over board``` and slicing to get the words:
...
Q04.38 Use the string ```rotten tomatoes``` and slicing to get the words:
...
Q04.46 Create a list with the numbers $1$ to $10$ (counting by ones). Use list slicing to pull out all of the numbers $5$ or less.

Q04.47 Create a list with the numbers $1$ to $10$ (counting by ones). Use list slicing to pull out all of the numbers $5$ and greater.
...
Q04.80 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.81 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.82 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.83 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.84 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.85 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.86 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.87 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
...
Q04.88 Run the following lines of code and explain the error in your own words, then write the lines of code to run without an error:
